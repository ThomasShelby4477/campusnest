...
export default function AdminLayoutClient({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-dvh bg-[#F1F5F9] flex flex-col md:flex-row">
      ...
      <aside
        className={`
          ...
          md:relative md:inset-auto md:translate-x-0 md:w-64 md:flex-shrink-0
      ...
      <div className="flex-1 flex flex-col min-w-0 min-h-dvh">
        ...
        {/* ── Scrollable content ─────────────────────────── */}
        <main className="flex-1 p-4 sm:p-5 md:p-8 pb-20 md:pb-8 overflow-y-auto">
          {children}
        </main>

        {/* ══════════════════════════════════════════════════
            MOBILE BOTTOM TAB BAR
            6 tabs — each is an icon + tiny label
        ══════════════════════════════════════════════════ */}
        <nav
