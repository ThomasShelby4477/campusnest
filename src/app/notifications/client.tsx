...
import { Bell, Check, CheckCircle2, MessageSquare, Heart, ShieldCheck, AlertCircle, HandHeart, XCircle, Trash2, RotateCcw } from 'lucide-react'
...
export function NotificationsClient({ initialNotifications, userId }: Props) {
  ...
  const getIcon = (type: string) => {
    switch (type) {
      ...
      case 'LISTING_RESTORED': return <RotateCcw className="w-5 h-5 text-success" />
