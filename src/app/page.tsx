            ...
            {features.map((f, i) => {
              ...
              return (
                <ScrollReveal key={i} delay={i * 80}>
                  <div className="group bg-white border border-border-light rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2 h-full">
            ...
            {steps.map((step, i) => (
              <ScrollReveal key={i} delay={i * 120}>
                <div className="relative group h-full">
                  <div className="bg-white/5 border border-white/10 backdrop-blur-sm rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 hover:-translate-y-1 h-full">
                    <span className="text-6xl font-black text-coral/30 group-hover:text-coral/60 transition-colors duration-300">{step.num}</span>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <ScrollReveal key={i} delay={i * 100}>
                <div className="bg-white border border-border-light rounded-2xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 h-full flex flex-col">
                  <div className="flex gap-1 mb-4">
                    {[...Array(5)].map((_, j) => (
                      <Star key={j} className="w-4 h-4 fill-warning text-warning" />
                    ))}
                  </div>
                  <p className="text-text-primary leading-relaxed mb-6 flex-1">&ldquo;{t.quote}&rdquo;</p>
